...
import me.afibarra.db.tables.records.StaffListRecord;
...
public class StaffList extends TableImpl<StaffListRecord> {
     ...
     */
    public final TableField<StaffListRecord, UByte> ID = createField(DSL.name("ID"), SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.TINYINTUNSIGNED)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super UByte, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super UByte, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super UByte, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super UByte, ? extends U> from) {
