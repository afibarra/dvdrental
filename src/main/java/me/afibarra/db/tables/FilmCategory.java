...
public class FilmCategory extends TableImpl<FilmCategoryRecord> {
     ...
     */
    public final TableField<FilmCategoryRecord, UShort> FILM_ID = createField(DSL.name("film_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sakila.film_category.category_id</code>.
     */
    public final TableField<FilmCategoryRecord, UByte> CATEGORY_ID = createField(DSL.name("category_id"), SQLDataType.TINYINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function3<? super UShort, ? super UByte, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function3<? super UShort, ? super UByte, ? super LocalDateTime, ? extends U> from) {
