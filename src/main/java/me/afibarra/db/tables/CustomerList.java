...
public class CustomerList extends TableImpl<CustomerListRecord> {
     ...
     */
    public final TableField<CustomerListRecord, UShort> ID = createField(DSL.name("ID"), SQLDataType.SMALLINTUNSIGNED.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.SMALLINTUNSIGNED)), this, "");
