...
public class Rental extends TableImpl<RentalRecord> {
     ...
     */
    public final TableField<RentalRecord, UShort> CUSTOMER_ID = createField(DSL.name("customer_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public final TableField<RentalRecord, UByte> STAFF_ID = createField(DSL.name("staff_id"), SQLDataType.TINYINTUNSIGNED.nullable(false), this, "");
