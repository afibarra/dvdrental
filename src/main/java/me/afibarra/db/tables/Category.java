...
public class Category extends TableImpl<CategoryRecord> {
     ...
     */
    public final TableField<CategoryRecord, UByte> CATEGORY_ID = createField(DSL.name("category_id"), SQLDataType.TINYINTUNSIGNED.nullable(false).identity(true), this, "");
    ...
    public Identity<CategoryRecord, UByte> getIdentity() {
        return (Identity<CategoryRecord, UByte>) super.getIdentity();
    }
