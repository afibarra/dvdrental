...
public class FilmActor extends TableImpl<FilmActorRecord> {
     ...
     */
    public final TableField<FilmActorRecord, UShort> ACTOR_ID = createField(DSL.name("actor_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sakila.film_actor.film_id</code>.
     */
    public final TableField<FilmActorRecord, UShort> FILM_ID = createField(DSL.name("film_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function3<? super UShort, ? super UShort, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function3<? super UShort, ? super UShort, ? super LocalDateTime, ? extends U> from) {
