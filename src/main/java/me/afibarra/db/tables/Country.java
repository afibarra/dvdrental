...
public class Country extends TableImpl<CountryRecord> {
     ...
     */
    public final TableField<CountryRecord, UShort> COUNTRY_ID = createField(DSL.name("country_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false).identity(true), this, "");
    ...
    public Identity<CountryRecord, UShort> getIdentity() {
        return (Identity<CountryRecord, UShort>) super.getIdentity();
    }
     ...
     */
    public <U> SelectField<U> mapping(Function3<? super UShort, ? super String, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function3<? super UShort, ? super String, ? super LocalDateTime, ? extends U> from) {
