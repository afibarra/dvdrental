...
public class City extends TableImpl<CityRecord> {
     ...
     */
    public final TableField<CityRecord, UShort> CITY_ID = createField(DSL.name("city_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<CityRecord, UShort> COUNTRY_ID = createField(DSL.name("country_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");
    ...
    public Identity<CityRecord, UShort> getIdentity() {
        return (Identity<CityRecord, UShort>) super.getIdentity();
    }
