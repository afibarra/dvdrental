...
public class ActorRecord extends UpdatableRecordImpl<ActorRecord> implements Record4<UShort, String, String, LocalDateTime> {
    ...
    @Override
    public Row4<UShort, String, String, LocalDateTime> valuesRow() {
    ...
    @Override
    public ActorRecord values(UShort value1, String value2, String value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
