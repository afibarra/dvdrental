...
public class CityRecord extends UpdatableRecordImpl<CityRecord> implements Record4<UShort, String, UShort, LocalDateTime> {
    ...
    @Override
    public Row4<UShort, String, UShort, LocalDateTime> valuesRow() {
    ...
    @Override
    public CityRecord values(UShort value1, String value2, UShort value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
