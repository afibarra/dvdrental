...
public class RentalRecord extends UpdatableRecordImpl<RentalRecord> implements Record7<Integer, LocalDateTime, UInteger, UShort, LocalDateTime, UByte, LocalDateTime> {
    ...
    @Override
    public Row7<Integer, LocalDateTime, UInteger, UShort, LocalDateTime, UByte, LocalDateTime> valuesRow() {
    ...
    @Override
    public RentalRecord values(Integer value1, LocalDateTime value2, UInteger value3, UShort value4, LocalDateTime value5, UByte value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
