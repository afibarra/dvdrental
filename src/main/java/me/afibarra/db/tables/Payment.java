...
public class Payment extends TableImpl<PaymentRecord> {
     ...
     */
    public final TableField<PaymentRecord, UShort> PAYMENT_ID = createField(DSL.name("payment_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>sakila.payment.customer_id</code>.
     */
    public final TableField<PaymentRecord, UShort> CUSTOMER_ID = createField(DSL.name("customer_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sakila.payment.staff_id</code>.
     */
    public final TableField<PaymentRecord, UByte> STAFF_ID = createField(DSL.name("staff_id"), SQLDataType.TINYINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sakila.payment.rental_id</code>.
     */
    public final TableField<PaymentRecord, Integer> RENTAL_ID = createField(DSL.name("rental_id"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.INTEGER)), this, "");
    ...
    public Identity<PaymentRecord, UShort> getIdentity() {
        return (Identity<PaymentRecord, UShort>) super.getIdentity();
    }
