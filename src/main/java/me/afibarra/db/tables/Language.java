...
public class Language extends TableImpl<LanguageRecord> {
     ...
     */
    public final TableField<LanguageRecord, UByte> LANGUAGE_ID = createField(DSL.name("language_id"), SQLDataType.TINYINTUNSIGNED.nullable(false).identity(true), this, "");
    ...
    public Identity<LanguageRecord, UByte> getIdentity() {
        return (Identity<LanguageRecord, UByte>) super.getIdentity();
    }
